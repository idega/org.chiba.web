 ...
 *
 * @author Joern Turner
 * @version $Id: WebAdapter.java,v 1.1 2007/03/15 10:23:42 civilis Exp $
...
public class WebAdapter extends AbstractChibaAdapter implements EventListener {
    ...
    public static final String WEB_ADAPTER = "chiba.web.adapter";
	...
	/**
	 * @return Returns the uiGenerator.
	 */
	...
	/**
	 * @param uiGenerator The uiGenerator to set.
	 */
