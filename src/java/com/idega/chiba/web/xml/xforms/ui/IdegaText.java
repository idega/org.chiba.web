/**
 * @(#)IdegaText.java    1.0.0 9:31:58 AM
 *
 ...
 *
 * @version 1.0.0 Mar 22, 2013
 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
 */
public class IdegaText extends Text {
	...
	protected boolean execute (Element action){
        String ifCondition = XFormsElement.getXFormsAttribute(action, "show");
