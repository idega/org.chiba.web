dojo.provide("chiba.widget.DropdownDateTimePicker");

dojo.require("dojo.date");
dojo.require("dojo.widget.DatePicker");
dojo.require("chiba.widget.Time");
...
//dateFormat: "%m/%d/%Y",
    ...
    fillInTemplate: function(args, frag) {
        ...
        args.date = this.currentDate;
        chiba.widget.DropdownDatePicker.superclass.fillInTemplate.call(this, args, frag);
