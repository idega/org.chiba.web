    ...
    <xsl:template match="xhtml:head">
        <head>
            ...
            <xsl:if test="$scripted='true'">
                ...
                <!-- dojo lib -->
                <script type="text/javascript" src="{concat($contextroot,$scriptPath,'dojo-0.4/dojo.js')}">&#160;</script>
                <xsl:text>
</xsl:text>
        ...
        <body>
            ...
            <div id="chiba-logo">
                <a href="resources/jsp/forms.jsp">
                    <img src="{concat($contextroot,'/resources/images/poweredby_sw.gif')}" style="border:none;" alt="powered by Chiba"/>
                </a>
            </div>
            <div id="copyright">
                <xsl:text disable-output-escaping="yes">&amp;copy; 2001-2007 Chiba Project</xsl:text>
            </div>
